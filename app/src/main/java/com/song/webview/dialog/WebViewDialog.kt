...
import com.song.webview.views.GTWebView
...
class WebViewDialog : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        width = preferenceManager.getInt(
            "width",
            view.context.resources.getInteger(R.integer.width_default)
        )
        height = preferenceManager.getInt(
            "height",
            view.context.resources.getInteger(R.integer.height_default)
        )
        url = preferenceManager.getString(
            "url",
            view.context.resources.getString(R.string.web_url_default)
        ).toString()
        val webView = view.findViewById<GTWebView>(R.id.webView)
